...
vực kỹ thuật như kiến trúc và y học. Kết xuất dựa trên vật lý là lớp giải thuật
mã hóa các định luật truyền ánh sáng thành mô hình
...
\textit{(Ký và ghi rõ họ tên)}\\[1.2cm]
Nguyễn Xuân Khôi
\end{flushright}
